...
Esta práctica se centra en el manejo de secuencias biológicas y herramientas bioinformáticas en R. A lo largo del guion se trabajan operaciones de lectura, manipulación y análisis de secuencias, así como la interpretación biológica de los resultados obtenidos.

Los objetivos principales son:

- Familiarizarse con estructuras de datos biológicas en R.
- Importar y manipular secuencias nucleotídicas y proteicas.
- Realizar análisis básicos de composición y similitud.
- Interpretar resultados desde una perspectiva bioinformática.
- Generar documentos reproducibles mediante Quarto.
...
La práctica permite aplicar herramientas fundamentales de bioinformática computacional utilizando R y Bioconductor. El trabajo con secuencias biológicas, la exploración de sus propiedades y la automatización de análisis mediante scripts reproducibles constituyen competencias esenciales en bioquímica, genómica y ciencias biomédicas.

El uso de Quarto facilita además la generación de informes integrados donde código, resultados e interpretación biológica quedan documentados conjuntamente.
