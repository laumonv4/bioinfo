...
En esta práctica se introducen los principios básicos del control de versiones mediante Git y su integración con Github. El uso de sistemas de control de versiones resulta fundamental en bioinformática y en desarrollo de software científico, ya que permite registrar cambios, mantener histórico de modificaciones, trabajar de forma reproducible y sincronizar proyectos entre distintos dispositivos y colaboradores.

Además de aprender comandos básicos de Git, esta práctica permite comprender conceptos fundamentales como repositorios, commits, ramas y sincronización remota con Github.
...
Puedes ver la configuración actual con `git config --list`.
 Cuando ejecuto en el temrinal 'git config --list' me devuelve:
 git config --list
core.editor=nano -w
init.defaultbranch=soca
...
Al ejecutar este comando, el terminal me devuelve: Inicializado repositorio Git vacío en /home/VMAULES/laumonv4/.git/
...
Al ejecutar git status, el terminal me devuelve:
...
Esta práctica permitió familiarizarse con el uso básico de Git y Github como herramientas fundamentales para el control de versiones y la reproducibilidad computacional. Se aprendió a inicializar repositorios, registrar cambios mediante commits, gestionar archivos ignorados con `.gitignore` y sincronizar repositorios locales con repositorios remotos en Github.

El uso de Git constituye una herramienta esencial en bioinformática moderna, ya que facilita el trabajo organizado, la trazabilidad de cambios y la colaboración en proyectos científicos.
